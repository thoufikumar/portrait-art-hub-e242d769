    ...
    <footer className="bg-white border-t border-gray-200 py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-semibold text-lg mb-4">Portrait Art Hub</h3>
            <p className="text-art-graphite text-sm">
              Creating beautiful, personalized portraits from your favorite photographs.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-sm text-art-graphite hover:text-art-charcoal">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/gallery" className="text-sm text-art-graphite hover:text-art-charcoal">
                  Gallery
                </Link>
              </li>
              <li>
                <Link to="/custom-order" className="text-sm text-art-graphite hover:text-art-charcoal">
                  Custom Orders
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-sm text-art-graphite hover:text-art-charcoal">
                  About Me
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-sm text-art-graphite">Email: contact@portraitarthub.com</li>
              <li className="text-sm text-art-graphite">Phone: +1 (555) 123-4567</li>
            </ul>
          </div>
          <div>
            <h3 className="font-semibold text-lg mb-4">Connect</h3>
            <div className="flex space-x-4">
              <a href="#" className="text-art-graphite hover:text-art-charcoal">
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          <p className="text-sm text-center text-art-graphite">
            © {new Date().getFullYear()} Portrait Art Hub. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
